 ...
 * @author YASH
 */
@WebServlet(name = "UpdaterBilldetails", urlPatterns = {"/UpdaterBilldetails"})
public class UpdaterBilldetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String str = "";
            if(status){
                str = "Billdetails details updated successfully...";
            }else{
                str = "Unable to update Billdetails details";
            }
