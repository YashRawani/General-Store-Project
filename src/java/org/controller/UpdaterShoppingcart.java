 ...
 * @author YASH
 */
@WebServlet(name = "UpdaterShoppingcart", urlPatterns = {"/UpdaterShoppingcart"})
public class UpdaterShoppingcart extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String str = "";
            if(status){
                str = "Shoppingcart details updated successfully...";
            }else{
                str = "Unable to update Shoppingcart details";
            }
