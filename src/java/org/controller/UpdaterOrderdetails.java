 ...
 * @author YASH
 */
@WebServlet(name = "UpdaterOrderdetails", urlPatterns = {"/UpdaterOrderdetails"})
public class UpdaterOrderdetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String str = "";
            if(status){
                str = "Orderdetails details updated successfully...";
            }else{
                str = "Unable to update Orderdetails details";
            }
