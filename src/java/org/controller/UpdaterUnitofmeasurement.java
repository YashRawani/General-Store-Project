 ...
 * @author YASH
 */
@WebServlet(name = "UpdaterUnitofmeasurement", urlPatterns = {"/UpdaterUnitofmeasurement"})
public class UpdaterUnitofmeasurement extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            boolean status = dao.update(u);
            String str = "";
            if(status){
                str = "Unitofmeasurement details updated successfully...";
            }else{
                str = "Unable to update Unitofmeasurement details";
            }
