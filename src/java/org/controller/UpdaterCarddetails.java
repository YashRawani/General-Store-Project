 ...
 * @author YASH
 */
@WebServlet(name = "UpdaterCarddetails", urlPatterns = {"/UpdaterCarddetails"})
public class UpdaterCarddetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String str = "";
            if(status){
                str = "Carddetails details updated successfully...";
            }else{
                str = "Unable to update Carddetails details";
            }
