 ...
 * @author YASH
 */
@WebServlet(name = "UpdaterShippingaddress", urlPatterns = {"/UpdaterShippingaddress"})
public class UpdaterShippingaddress extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String str = "";
            if(status){
                str = "Shippingaddress details updated successfully...";
            }else{
                str = "Unable to update Shippingaddress details";
            }
