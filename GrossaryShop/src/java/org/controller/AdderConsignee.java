 ...
 * @author YASH
 */
@WebServlet(name = "AdderConsignee", urlPatterns = {"/AdderConsignee"})
public class AdderConsignee extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String str = "";
            if(status){
                str = "Consignee details added successfully...";
            }else{
                str = "Unable to add Consignee details";
            }
