 ...
 * @author YASH
 */
@WebServlet(name = "AdderGiftvoucher", urlPatterns = {"/AdderGiftvoucher"})
public class AdderGiftvoucher extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            boolean status = dao.add(g);
            String str = "";
            if(status){
                str = "Giftvoucher details added successfully...";
            }else{
                str = "Unable to add Giftvoucher details";
            }
