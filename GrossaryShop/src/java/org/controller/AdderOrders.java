 ...
 * @author YASH
 */
@WebServlet(name = "AdderOrders", urlPatterns = {"/AdderOrders"})
public class AdderOrders extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String str = " ";
            if(status){
                str = "Orders details added successfully...";
            }else{
                str = "Unable to add Orders details";
            }
